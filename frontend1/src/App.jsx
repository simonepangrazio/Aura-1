...
import Frontend2Redirect from './pages/Frontend2Redirect'
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/login"             element={<Frontend2Redirect path="/login" />} />
        <Route path="/dashboard"         element={<Frontend2Redirect path="/dashboard" />} />
