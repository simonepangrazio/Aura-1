...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#08080e] text-white overflow-x-hidden">
      ...
      {/* ── HERO ────────────────────────────────────────────── */}
      <section className="relative flex items-center min-h-screen pt-28 pb-24 px-6">
        {/* ambient blobs */}
          ...
          <div className="flex flex-col gap-9">
            ...
            <div className="flex flex-wrap gap-4">
              <button
                ...
                style={{ background:'linear-gradient(135deg,#7c3aed,#0891b2)', boxShadow:'0 0 50px rgba(124,58,237,0.45)', border:'none', color:'#fff', fontWeight:700, fontSize:'1rem', padding:'1rem 2rem', borderRadius:'1rem', cursor:'pointer', display:'inline-flex', alignItems:'center', gap:10 }}
              >
                Richiedi una Demo
        ...
        <div className="max-w-6xl mx-auto">
          <div style={{ background:'linear-gradient(135deg, rgba(124,58,237,0.12) 0%, rgba(8,8,14,0) 50%, rgba(8,145,178,0.08) 100%)', border:'1px solid rgba(255,255,255,0.07)', borderRadius:'2.5rem', padding:'5rem', position:'relative', overflow:'hidden' }}>
            ...
            <div style={{ position:'relative', display:'grid', gridTemplateColumns:'1fr 1fr', gap:'5rem', alignItems:'center' }}>
              {/* text */}
              <div>
                <div style={{ display:'inline-flex', alignItems:'center', gap:8, background:'rgba(124,58,237,0.12)', border:'1px solid rgba(124,58,237,0.25)', borderRadius:999, padding:'8px 18px', fontSize:'0.75rem', color:'#a78bfa', marginBottom:'1.75rem' }}>
                ...
                <ul style={{ listStyle:'none', padding:0, margin:0, display:'flex', flexDirection:'column', gap:'0.875rem' }}>
                  {['Demo personalizzata sul tuo settore', 'Consulenza con un AI specialist', 'Analisi delle tue esigenze specifiche', 'Preventivo su misura senza impegno'].map(item => (
                    <li key={item} style={{ display:'flex', alignItems:'center', gap:12, fontSize:'0.9rem', color:'#a1a1aa' }}>
              ...
              <div style={{ background:'rgba(255,255,255,0.04)', border:'1px solid rgba(255,255,255,0.08)', borderRadius:'1.5rem', padding:'2.5rem' }}>
                ...
                <div style={{ display:'flex', flexDirection:'column', gap:'0.875rem' }}>
                  ...
                  <button
                    onClick={() => navigate('/demo')}
                    style={{ marginTop:8, background:'linear-gradient(135deg,#7c3aed,#0891b2)', border:'none', color:'#fff', fontWeight:700, fontSize:'0.9rem', padding:'0.875rem', borderRadius:'0.75rem', cursor:'pointer', boxShadow:'0 0 30px rgba(124,58,237,0.35)', width:'100%' }}
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div style={{ display:'flex', gap:'1rem', justifyContent:'center', flexWrap:'wrap' }}>
            <button onClick={() => navigate('/demo')}
              style={{ background:'linear-gradient(135deg,#7c3aed,#0891b2)', boxShadow:'0 0 60px rgba(124,58,237,0.5)', border:'none', color:'#fff', fontWeight:700, fontSize:'1.05rem', padding:'1.1rem 2.5rem', borderRadius:'1.125rem', cursor:'pointer', display:'inline-flex', alignItems:'center', gap:10 }}
              onMouseEnter={e => e.currentTarget.style.opacity='.85'}
              onMouseLeave={e => e.currentTarget.style.opacity='1'}
            >
              Richiedi una Demo
