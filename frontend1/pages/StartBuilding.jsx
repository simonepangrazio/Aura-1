      ...
      <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-6">
        ...
        <div className="max-w-lg w-full text-center">
          ...
          <p className="text-zinc-400 text-lg leading-relaxed mb-2">
            La tua richiesta per <span className="text-violet-400 font-semibold">"{form.name}"</span> sta venendo visionata da un nostro specialista.
          </p>
      ...
      <div className="max-w-6xl mx-auto px-6 pt-32 pb-16 grid lg:grid-cols-[1fr_420px] gap-8">
        ...
        <div>
          <h1 className="font-display text-5xl font-800 mb-2">
            ...
            <br />
            <span className="bg-gradient-to-r from-violet-400 to-cyan-400 bg-clip-text text-transparent">Agent AI</span>
          </h1>
